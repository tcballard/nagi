(()=>{
 ...
 function stop(){restore();document.removeEventListener('mousemove',move,true);document.removeEventListener('click',pick,true);document.removeEventListener('keydown',key,true);window.__nagiPicking=false;delete window.__nagiCancelPick;}
